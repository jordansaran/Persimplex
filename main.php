                ...
                <div id="principal" class="container z-depth-5">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            <input id="decisao" type="number" class="validate black-text tooltipped" name="decisoes" value="2" min="2" max="20" data-position="top" data-delay="3" data-tooltip="Número de variáveis de decisão para solucionar o problema">
                            <label for="decisao">Quantas variáveis de decisão o problema contém ?</label>
                        </div>
                        <div class="input-field col s6">
                            <input id="restricao" type="number" class="validate black-text tooltipped" name="restricoes" value="0" min="0" max="40" data-position="top" data-delay="3" data-tooltip="Número de variáveis de restrições para solucionar o problema">
